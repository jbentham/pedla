...
# v0.02 JPB 13/5/22  Convert data to 16-bit words
# v0.03 JPB 13/5/22  Added do_load function
# v0.04 JPB 14/5/22  Added functions to set capture parameters
#                    Added 'verbose' flag
...
class EdlaUnit(object):
    ...
    def status_got_samp(self, status):
        #print("nsamp %u, xsamp %u" % (status['nsamp'], status['xsamp']))
